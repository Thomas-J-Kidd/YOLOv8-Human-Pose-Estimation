...
def parse_opt():
    ...
    Example use:
    python pose_predict.py --model yolov11n-pose.pt --source 0 --is_video --view-img # webcam
    python pose_predict.py --model yolov11n-pose.pt --source video.mp4 --is_video --save-img --view-img
    python pose_predict.py --model yolov11n-pose.pt --source img_name.jpg --save-img --view-img
    python pose_predict.py --model yolov11n-pose.pt --source folder_name --save-img
    """
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--model", type=str, default="yolov11n-pose.pt", help="initial weights path"
    )
    parser.add_argument(
